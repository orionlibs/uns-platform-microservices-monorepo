...
import io.github.orionlibs.gateway_home.document.converter.DocumentEntityToDTOConverter;
...
public class GetDocumentsByTypeAPIController
{
    ...
    public ResponseEntity<DocumentsDTO> getDocumentsByType(@PathVariable DocumentType documentType)
    {
